...
в результате чего производится видоизменение файла и различные побочные действия.
...
встроенным файловым валидатором, который воспринимает наличие ранее загруженного
...
разработан класс `Migration`. Для использования необходимо унаследоваться от этого класса.
